...
# Memory: serialflash
MEM_2 := nios_serialflash_boot_rom
$(MEM_2)_NAME := serialflash
...
$(MEM_2)_END := 0x000027ff
$(MEM_2)_SPAN := 0x00000800
$(MEM_2)_HIERARCHICAL_PATH := serialflash
$(MEM_2)_WIDTH := 32
...
.PHONY: serialflash
serialflash: check_elf_exists $(HDL_SIM_DIR)/$(MEM_2).hex $(HDL_SIM_DIR)/$(MEM_2).dat $(HDL_SIM_DIR)/$(MEM_2).sym $(MEM_2).flash
